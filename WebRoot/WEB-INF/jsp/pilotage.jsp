...
<div class="width-box">
        ...
        <div class="col-xs-12 col-sm-10 pd-xs-l25 mg-xs-t15">
            <div class="over-hide bg-fff pd-all-15" id="right">
              <!--   <div id="more">
               ...
               <!--  <div id="newsList">
                    <ul>
                        <li><a href="#">2018年中央企业网络安全和信息化工作培训班在京召开<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">郝鹏出席推进中央企业基层党建座谈会强调 认真学习贯彻习近平总书记关于党的建设和组织工作重要思想<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">国务院国资委主办首届进博会中央企业国际合作论坛<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">中央企业党的建设工作座谈会召开<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">三位全国劳模当选全总兼职副主席<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">国资委党委召开中央企业警示教育大会 坚决贯彻落实习近平总书记关于巡视工作重要指示精神 <span style="float: right"> >>> </span></a></li>
                        <li><a href="#">国资委召开中央企业脱贫攻坚工作视频会议<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">温暖“一带一路”<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">中央企业要走在高质量发展前列<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">1-5月中央企业生产经营持续向好 经济效益快速提升<span style="float: right"> >>> </span></a></li>
                    </ul>
                </div> -->
                 ...
                 <div id="newsList">
                    <ul>
                       ...
                       <c:forEach items="${detailsList}" var="details" varStatus="status">
                        <li style=""><a  style="" href="news?detailsTypeId=${details.detailsTypeId}&detailsId=${details.detailsId}">
                         <span style="display:inline-block;text-overflow:ellipsis; overflow:hidden;
                         white-space: nowrap;vertical-align:-32%; width:796px;">${details.title}</span><span style="float: right"> >>> </span></a></li>
                       </c:forEach>
   ...
   <!--分页-->
           <%--   <div class="fenye"><div class="manu" style="margin-top:15px"><span class="disabled">
             < 上一页</span><span class="current">1</span><a href="#" target="_self">2</a><a href="#" target="_self">3</a><a href="#" target="_self">4</a><a href="#" target="_self">5</a><%=path%>/statics.<a href="#">11</a><a href="#">下一页 ></a></div>
</div> --%>
