                    ...
                    <ul>
                       ...
                       <c:forEach items="${detailsList}" var="details" varStatus="status">
                        <li style="">
                         ...
                         <a style="" href="news?detailsTypeId=${details.detailsTypeId}&detailsId=${details.detailsId}">
                         
                       <span  style="display:inline-block; width:796px; white-space: nowrap;text-overflow:ellipsis; overflow:hidden;
                         vertical-align:-32%; ">${details.title}</span><span style="float:right">>>></span> </a>
                       </c:forEach>
