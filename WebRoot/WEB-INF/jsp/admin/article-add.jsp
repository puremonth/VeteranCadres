...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="newsSave" onsubmit="window.opener=null;window.close();"  method="post" enctype="multipart/form-data">
		<input id="pageNow" name="pageNow"  type="hidden"  value="${page.pageNow}"/>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>文章标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="newsTitle" name="newsTitle" >
			</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="newsAuthor">
			</div>
		</div>
	...
	<div class="row cl">
		...
		<div style="" class="row cl">
			<label class="form-label col-xs-4 col-sm-2">排序值：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="" name="newsOrderValue">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button class="btn btn-primary radius" type="onsubmit"><i class="Hui-iconfont">&#xe632;</i> 保存并发布</button>
...
/* alert($('#form-article-add').onSubmit());
while($(form).ajaxSubmit()){
var index = parent.layer.getFrameIndex(window.name);
			parent.$('.btn-refresh').click();
	parent.layer.close(index); 
}
