                ...
                <div id="newsList">
                    <ul>
                      ...
                      <c:forEach items="${detailsList}" var="details" varStatus="status">
                        <li style=""><a href="news?detailsTypeId=${details.detailsTypeId}&detailsId=${details.detailsId}">
                        <span style="display:inline-block;text-overflow:ellipsis; overflow:hidden;
                         white-space: nowrap;vertical-align:-32%; width:796px;">${details.title}</span>
                        <span style="float: right"> >>> </span></a></li>
                       </c:forEach>
                       <!--  <li><a href="#">豆张庄镇深入谋划迅速行动积极备战迎检 全力投入冲刺<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">石各庄镇扎实推进“大棚房”清理整治高标准完成好复垦工作<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">    黄庄街扎实推进创建全国文明城区和创建国家卫生区工作<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">陈咀镇深入谋划工作思路举措<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">东蒲洼街在“双创”工作中治理违法违规 改善生活环境<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">河西务镇以三季度高质量发展推动会精神为指引学先进制定措施 助推工作上水平<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">高村镇组织退役军人赴北京某部队参观学习<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">梅厂镇开展扫黑除恶专项斗争落实主体责任 确保和谐稳定<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">翠亨西社区开展青少年环境清理活动<span style="float: right"> >>> </span></a></li>
                        <li><a href="#">大孟庄镇开展“大棚房”清理大整治<span style="float: right"> >>> </span></a></li> -->
                    </ul>
                </div>
            </div>
            <!--over-hide end-->
