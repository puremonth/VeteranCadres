...
<div class="content_left fl">
           ...
           <c:forEach items="${detailsList}" var="details" varStatus="status">
                <li class="list clearfix">  
                    <div class="list_left fl"><a target="_blank" href="news?detailsTypeId=${details.detailsTypeId}&detailsId=${details.detailsId}"><img src="<%=path%>/${details.coverPic}" alt="即将更新" title="课程安排" width="176px" height="117px"></a></div>
                    <h2><a href="news?detailsTypeId=${details.detailsTypeId}&detailsId=${details.detailsId}" target="_blank">${details.title}</a></h2>
                   <%-- <a href="#" target="_blank"><%=path%>/statics.详细&gt;&gt;</a> --%><p value="${fn:substring(details.content,0,169)}"></p>
