...
<head>
    ...
    <link rel='stylesheet' href='<%=path%>/statics/css/style.css' type="text/css">
    ...
    <div class="row pd-t40">
        <div class="col-xs-12 col-sm-2 over-hide bg-fff pd-b50">
            <ul class="left_menu pd-t5">
                <li class="active">
                    <a href="teacher-presence">教师风采</a>
                </li>
               <!--  <li>
                   <a href="#">教学实绩</a>
               </li>
...
<div class="topban" alias="jsfc"></div>
    ...
    <div class="nymain">
      ...
      <%--           <li><a href='#' target='_blank' title='马晓博'><img src='<%=path%>/statics/image/js2.jpg' /><span>马晓博</span></a></li>
                <li><a href='#' target='_blank' title='许冬玲'><img src='<%=path%>/statics/image/js3.jpg' /><span>许冬玲</span></a></li>
                <li><a href='#' target='_blank' title='胡莉萍'><img src='<%=path%>/statics/image/js4.jpg' /><span>胡莉萍</span></a></li>
                <li><a href='#' target='_blank' title='娄净超'><img src='<%=path%>/statics/image/js5.jpg' /><span>娄净超</span></a></li>
                <li><a href='#' target='_blank' title='张锐'><img src='<%=path%>/statics/image/js6.jpg' /><span>张锐</span></a></li>
                <li><a href='#' target='_blank' title='王诗愉'><img src='<%=path%>/statics/image/js7.jpg' /><span>王诗愉</span></a></li>
                <li><a href='#'  target='_blank' title='冯兵兵'><img src='<%=path%>/statics/image/js8.jpg'/><span>冯兵兵</span></a></li>
                <li><a href='#' target='_blank' title='李永成'><img src='<%=path%>/statics/image/js9.jpg' /><span>李永成</span></a></li>
                <li><a href='#'  target='_blank' title='何远顺'><img src='<%=path%>/statics/image/js10.jpg' /><span>何远顺</span></a></li>
                <li><a href='#' target='_blank' title='侯巍'><img src='<%=path%>/statics/image/js11.jpg' /><span>侯巍</span></a></li>
                <li><a href='#' target='_blank' title='孙士放'><img src='<%=path%>/statics/image/js12.jpg' /><span>孙士放</span></a></li>
                <li><a href='#' target='_blank' title='刘珩'><img src='<%=path%>/statics/image/js13.jpg' /><span>刘珩</span></a></li>
                <li><a href='#' target='_blank' title='吴艳辉'><img src='<%=path%>/statics/image/js14.jpg' /><span>吴艳辉</span></a></li>
                <li><a href='#' target='_blank' title='刘丽斋'><img src='<%=path%>/statics/image/js15.jpg' /><span>刘丽斋</span></a></li>
                <li><a href='#' target='_blank' title='宋润锋'><img src='<%=path%>/statics/image/js16.jpg' /><span>宋润锋</span></a></li>
                <li><a href='#' target='_blank' title='吴珂'><img src='<%=path%>/statics/image/js17.jpg' /><span>吴珂</span></a></li>
                <li><a href='#' target='_blank' title='张楠'><img src='<%=path%>/statics/image/js18.jpg' /><span>张楠</span></a></li>
                <li><a href='#' target='_blank' title='吴少平'><img src='<%=path%>/statics/image/js19.jpg' /><span>吴少平</span></a></li>
                <li><a href='#' target='_blank' title='李方方'><img src='<%=path%>/statics/image/js20.jpg' /><span>李方方</span></a></li> --%>
                <div class="clear"></div>
                </ul>
            </div>
            <!--分页-->
